...
export const docsStructure = [
  ...
  },
  {
    ...
    items: [
      { slug: "latam", label: "Digital Culture in LatAm", icon: <Globe className="h-4 w-4" /> },
      { slug: "cnn", label: "Dobprotocol on CNN Radio", icon: <Radio className="h-4 w-4" /> },
      { slug: "first-ai", label: "DOBI: First AI Token in LatAm", icon: <Trophy className="h-4 w-4" /> },
  ...
  },
  {
    ...
    items: [
      { slug: "technology", label: "Technology behind Dobprotocol", icon: <Cpu className="h-4 w-4" /> },
